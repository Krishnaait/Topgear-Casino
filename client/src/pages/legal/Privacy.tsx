    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="py-6 sm:py-4 sm:py-6 md:py-8 lg:py-12 lg:py-16 bg-card/30 border-b border-border">
        <div className="container px-3 sm:px-4 lg:px-6">
          <h1 className="text-2xl sm:text-xl sm:text-lg sm:text-xl md:text-2xl lg:text-3xl lg:text-4xl lg:text-5xl font-bold text-foreground mb-4">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-muted-foreground">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-card border border-border rounded-lg p-2 sm:p-3 md:p-4 space-y-4">
                  <div>
